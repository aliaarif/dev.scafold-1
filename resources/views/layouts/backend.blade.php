	...
	<section id="main">
		<aside id="notifications">
			...
			<div class="tab-content">
				<div class="tab-pane" id="notifications__messages">
					...
					<a href="index.html" class="btn btn--float">
		...
		<aside id="navigation">
			...
			<div class="navigation__toggles">
				<a href="index.html" class="active" data-mae-action="block-open" data-mae-target="#notifications" data-toggle="tab" data-target="#notifications__messages">
					<i class="zmdi zmdi-email"></i>
				</a>
				<a href="index.html" data-mae-action="block-open" data-mae-target="#notifications" data-toggle="tab" data-target="#notifications__updates">
					<i class="zmdi zmdi-notifications"></i>
				</a>
				<a href="index.html"  data-mae-action="block-open" data-mae-target="#notifications" data-toggle="tab" data-target="#notifications__tasks">
			...
			<div class="navigation__menu c-overflow">
				<ul>
					...
					<li class="navigation__sub">
						<a href="index.html" data-mae-action="submenu-toggle"><i class="zmdi zmdi-view-list"></i> Tables</a>
					...
					<li class="navigation__sub">
						<a href="index.html" data-mae-action="submenu-toggle"><i class="zmdi zmdi-collection-text"></i> Forms</a>
						<ul>
					...
					<li class="navigation__sub">
						<a href="index.html" data-mae-action="submenu-toggle"><i class="zmdi zmdi-swap-alt"></i>User Interface</a>
						<ul>
					...
					<li class="navigation__sub">
						<a href="index.html" data-mae-action="submenu-toggle"><i class="zmdi zmdi-trending-up"></i>Charts</a>
						<ul>
					...
					<li class="navigation__sub">
						<a href="index.html" data-mae-action="submenu-toggle"><i class="zmdi zmdi-image"></i>Photo Gallery</a>
						<ul>
					...
					<li class="navigation__sub">
						<a href="index.html" data-mae-action="submenu-toggle"><i class="zmdi zmdi-collection-item"></i> Sample Pages</a>
						<ul>
